...
variable "ami_users" {
  ...
  type        = list(string)
  default     = ["ubuntu", "ubuntu", "ubuntu", "ubuntu", "ubuntu", "ec2-user", "ec2-user", "centos", "centos", "centos", "admin", "admin", "admin", "ec2-user", "ec2-user", "ec2-user", "ec2-user", "ec2-user", "ec2-user"]
}
